...
public class ManagerWorkPlanListTest extends AcmePlannerTest {
	...
	@Order(10)
	public void listAll(final int recordIndex, final String title, final String description, final String executionStart, final String executionEnd, final String isPublic,final String published) {
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/manager/workPlan/list-all-negative.csv", encoding = "utf-8", numLinesToSkip = 1)
	@Order(20)
